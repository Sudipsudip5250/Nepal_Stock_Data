...
# Uses the repository variable to build the URL dynamically
GITHUB_RAW_URL = "https://raw.githubusercontent.com/${{ github.repository }}/main/other_nepse_detail/listed_company.csv"
